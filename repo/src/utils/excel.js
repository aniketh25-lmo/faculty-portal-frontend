...
function formatPublicationRow(pub, selectedColumns) {
  ...
  const fullRow = {
    ...
    "WoS Category": clean(pub.wos_category),
    "DOI": clean(pub.doi),
    "Paper URL": clean(pub.paper_url),
    "Publisher URL": clean(pub.publisher_url),
...
const COLUMN_WIDTHS = {
  ...
  "Academic Year": 14, "Department": 14, "Volume / Issue / Pages": 22, "WoS Category": 28,
  "DOI": 28, "Paper URL": 45, "Publisher URL": 45, "Abstract": 40, "Scholar Citations": 16,
...
export function generateExcelReport(reportTitle, authorProfiles, rawPublications, filters = {}) {
  ...
  const summaryRows = [
    ...
    { "Metric": "Generated By", "Value": "AcademicPulsePro v6.0 — Faculty Research Portal" }
  ]
